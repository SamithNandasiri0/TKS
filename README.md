...
## How to use
*** You must install [NodeJS](https://nodejs.org/) on your host PC (Windows, Linux, MacOS) to run the following npm commands
1. Run `npm install` for install dependencies
2. Run `npm start`
3. Open `http://[IP]:[port]/scoreboard` for scoreboard*
4. Open `http://[IP]:[port]/admin` for admin*
5. Open `http://[IP]:[port]/judge` or scan the QR code on the admin page for judge*
